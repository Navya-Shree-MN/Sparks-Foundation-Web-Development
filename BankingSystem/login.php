...
<head>
    ...
    @define('bankname', 'Banking Sytem',true);
...
<center><h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"></small></h1>
<center><br>
<?php echo $error ?>
<br>
